...
const VFlowTrigger = (function () {
  ...
  async function trigger_vflow_workflow(params: TriggerParams): Promise<any> {
  ...
  return {
    trigger_vflow_workflow: (params: TriggerParams) => wrapToolExecution(trigger_vflow_workflow, params)
  };
})();
