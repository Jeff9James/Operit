...
class ModelConfigManager(private val context: Context) {
    ...
    suspend fun updateApiSettingsFull(
        ...
        return updateConfigInternal(configId) {
            val resolvedEnableToolCall =
                if (apiProviderType == ApiProviderType.MNN || apiProviderType == ApiProviderType.LLAMA_CPP || apiProviderType == ApiProviderType.CACTUS_LOCAL) {
                    false
                } else {
                    enableToolCall
                }
    ...
    suspend fun updateToolCall(configId: String, enableToolCall: Boolean): ModelConfigData {
        return updateConfigInternal(configId) {
            val resolvedEnableToolCall =
                if (it.apiProviderType == ApiProviderType.MNN || it.apiProviderType == ApiProviderType.LLAMA_CPP || it.apiProviderType == ApiProviderType.CACTUS_LOCAL) {
                    false
                } else {
                    enableToolCall
                }
